...
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('1','0', '1', '/Manager/Index', '首页', '1');
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('2','0', '1', '/ThesisMgr/Index', '论文管理', '1');
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('3','0', '1', '/CostMgr/Index', '费用管理', '1');
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('4','0', '1', '/NoticeMgr/Index', '通知公告', '1');
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('5','0', '1', '/OrgMgr/Index', '架构管理', '1');


INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('6','2', '2', '/ThesisMgr/Check', '论文审核', '1');
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('7','2', '2', '/ThesisMgr/BatchSubmit', '批量提交', '1');
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('8','2', '2', '/ThesisMgr/Feedback', '加工反馈', '1');
INSERT INTO `thesisdb`.`menu` (`Id`,`ParentId`, `Level`, `MenuUrl`, `MenuName`, `Status`) VALUES ('9','2', '2', '/ThesisMgr/Rewards', '薪酬管理', '1');
